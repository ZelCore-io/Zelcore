export default {
  message: {
    ...
    easy_login_info: "Zel ID Gemakkelijk inloggen: Geef een geheime zin op.",
    ...
    zel_id_disable_easy_login: "Zel ID - Schakel gemakkelijk inloggen uit",
    zel_id_easy_login: "Zel ID - Gemakkelijk inloggen",
    easy_login: "Gemakkelijk inloggen",
    ...
    set_up_easy_login: "Gemakkelijk inloggen instellen",
    verify_easy_login: "verifieer Easy Login zin",
    easy_login_bio: "Met gemakkelijk inloggen kunt u zich aanmelden bij uw account met een geselecteerde wachtwoordzin of biometrische gegevens. U kunt gemakkelijk inloggen alleen activeren als d2FA is ingeschakeld.",
    disable_easy_login: "Schakel gemakkelijk inloggen uit",
    only_one_account_easy: "Slechts één lokaal account kan gekoppeld worden met Zel ID gemakkelijk inloggen. Deze actie kan de gemakkelijk inloggen optie uitschakelen voor een andere account. Weet u zeker dat u gemakkelijk inloggen wilt uitschakelen?",
    disable_d2fa: "Schakel d2FA uit",
    set_up_d2fa: "d2FA instellen",
    d2fa_adds_security: "d2FA voegt een extra laag van bescherming en veiligheid toe. Het uitschakelen van d2FA zal ook gemakkelijk inloggen uitschakelen. Weet u zeker dat u d2FA wilt uitschakelen?",
    ...
    new_pin: "Nieuwe PIN",
    easy_login_text: "Met Zel ID gemakkelijk inloggen kunt u zich snel aanmelden bij uw account met een wachtwoord, pin, vingerafdruk of Face ID. Easy Login vereist dat d2FA is geactiveerd op uw account en kan slechts voor één account per apparaat worden geactiveerd.",
    easy_login_disabled: "Gemakkelijk inloggen uitgeschakeld",
    easy_sign_phrase: "Ongeldige ondertekeningszin",
    easy_login_phrase_no_match: "Gemakkelijk inloggen zinnen komen niet overeen",
    easy_login_activated: "Gemakkelijk inloggen geactiveerd",
