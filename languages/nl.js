export default {
  message: {
    ...
    create_recover_password: "Here you can set your recovery password mechanism. You will have to select at least 3 questions to create this security mechanism and continue with account creation. Use as many questions as you wish. "
    ...
    credentials_key: "Your account credentials are the key to access your funds, make it as strong as possible.",
    zelcore_self_custody: "Zelcore is a self custodial platform",
    credentials_account: "There is no way to retrieve or change your username nor password. If you lose either your username or password, you will lose access to your account permanently.",
