...
export default {
  message: {
    ...
    // Flux ID
    pin: "PIN",
    d2fa_pin: "Flux ID: Detta konto är skyddat av d2FA. Ange PIN",
    easy_login_info: "Flux ID Easy Login: Vänligen ge en hemlig fras.",
    easy_login: "Easy Login",
    sign_message: "Skriv ett meddelande",
    easy_sign_message: "Enkel signering av meddelanden med din Flux ID",
    ...
    only_one_account_easy: "Endast ett lokalt konto kan kopplas till Flux ID Easy Login. Den här åtgärden kan inaktivera alternativet Easy Login för ett annat konto. Är du säker på att du vill inaktivera Easy Login-alternativet?",
