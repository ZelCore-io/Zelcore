...
export default {
  message: {
    ...
    warning_polygon_contracts: "Polygon Chain contracts take a few minutes to be show on the explorers. Contracts require you to have a balance of POL on Polygon Chain so that it can be used as Gas to power the contracts execution.",
    ...
    warning_base_contracts: "Base Chain contracts take a few minutes to be show on the explorers. Contracts require you to have a balance of BASE on Base Chain so that it can be used as Gas to power the contracts execution.",
    warning_arbitrum_contracts: "Arbitrum Chain contracts take a few minutes to be show on the explorers. Contracts require you to have a balance of ARB on Arbiturm Chain so that it can be used as Gas to power the contracts execution.",
    warning_fantom_contracts: "Fantom Chain contracts take a few minutes to be show on the explorers. Contracts require you to have a balance of FTM on Fantom Chain so that it can be used as Gas to power the contracts execution.",
    warning_optimism_contracts: "Optimism Chain contracts take a few minutes to be show on the explorers. Contracts require you to have a balance of OP on Optmism Chain so that it can be used as Gas to power the contracts execution.",
    warning_blast_contracts: "Blast Chain contracts take a few minutes to be show on the explorers. Contracts require you to have a balance of BLAST on Blast Chain so that it can be used as Gas to power the contracts execution.",
    warning_zksync_contracts: "ZkSync Era contracts take a few minutes to be show on the explorers. Contracts require you to have a balance of ETH on ZkSync Era so that it can be used as Gas to power the contracts execution.",
