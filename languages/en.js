export default {
  message: {
    ...
    terra_imported_tokens: "Imported Terra Tokens",
    ...
    import_terra_token: "Import Terra Token",
    ...
    fio_balance_error: "At least 20 FIO needs to be present in your first wallet to pay network fee",
    ...
    fio_register_info: "Registers your FIO Crypto Handle and ties it with your selected Zelcore wallet. After registration is completed, you can manage your FIO Crypto Handle directly from Zelcore. FIO Crypto Handle costs up to 20 FIO to register.",
