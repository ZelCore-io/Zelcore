export default {
  message: {
    ...
    confirm_delete_account: "Confirm Account deletion to delete your account on this device",
    account_deleted: "Account deleted on this device",
    yes_delete_account: "Yes, delete account {account}",
    action_undone_account: "This action can not be undone. Deletion of your account will erase all information about the account on this device. Make sure you have your credentials somewhere backed up as well as your private keys.",
    ...
    login: "Login",
    add_to_device: "Add Account to Device",
    ...
    // create.vue
    create_account_info: "These credentials are used to generate your wallets and your accounts encryption.",
    create_account_info2: "Both username and password are case sensitive. Make them strong.",
    ...
    credentials_key: "Your account crendetials are the key to access your funds, make it as strong as possible.",
    zelcore_self_custody: "Zelcore is a self custodial platform",
    credentials_account: "There is no way to retrieve or change your username nor password. If you lose either your username or password, you will lose access to your account premanently.",
    credentials_account2: "It is very important that you keep a copy of your crendentials somewhere safe.",
    ...
    insert_decimals_trc: "Insert number of token decimal places, usually 8",
    ...
    warning_eth: "Not using enough gas may result in transaction failiure. Unsued gas will be returned.",
    ...
    setup_zelnodes_guide_info: "Provides an easy to use step by step walkthrough guide on setting up a Basic, Super or BAMF FluxNode",
    ...
    something_went_wrong_wallet_encryption: "Something went wrong during wallet encyption. Please kill zelcore process and contact the Zelcore Team.",
    ...
    portfolio_mode_message: "Controls visibility of your portfolio values. You can choose between displaying portfolio value in Fiat, BTC or stay hidden. Hidden option will have values as well as your username blurred. This settings can also be changed by clicking the donut in Portfolio",
    ...
    all_zelnodes_monitoring_online: "All the FluxNodes you are moniting are confirmed on the network",
  },
};
