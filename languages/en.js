  ...
  package: {
    wallet_proxy: {
      ...
      pairing: {
        ...
        description: {
          error: "There was an error while attempting to pair with {peerUrl}. If the problem persists try refreshing dApp \"{peerUrl}\" and/or attempting to re-pair.",
          disconnected: "You have successfully disconnected from peer.",
          invalid_chain_error: "Required chains, not supported by Zelcore, were requested by {peerUrl}. Pair request has been rejected.",
          // pending: "",
      ...
      signing: {
        title: {
          ...
          proposal: "Incoming Transaction Proposal",
          rejected: "Transaction Proposal Successfully Rejected",
          rejected_error: "Transaction Proposal Unsuccessfully Rejected",
          hash_created: "Transaction Submitted",
        },
        description: {
          processed: "Incoming request has been successfully processed.",
          error: "There was an error while processing your transaction. This error originated from Wallet Connect and/or {peerUrl}.",
          // pending: "",
          // proposal: "",
          // rejected: "",
          rejected_error: "There was an error while processing your rejection. This error originated from Wallet Connect and/or {peerUrl}.",
