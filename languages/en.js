export default {
  message: {
    ...
    daemon_not_starting: "Full node wallet is not starting. Usually when fullnode doesn`t start it can be related to firewall or bad wallet/masternode/zelnode configuration file. Please check those before trying the reindex option.",
