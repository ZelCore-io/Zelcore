export default {
  message: {
    ...
    d2fa_requires_minimum: "d2FA requires a small amount of 0.0002 ZEL to be present in your wallet in order to broadcast a d2FA enable transaction. Your d2FA pin will be set after the transaction is confimred on the blockchain and you have re-logged in.",
    ...
    memo: "Memo",
    memo2: "Memo:",
    warning_eth_contracts: "Warning: Ethereum contracts takes a few minutes to be show on the explorers. Contracts require you to have a balanace of ETH so that it can be used as Gas to power the contracts execution.",
    ...
    full_node_launch_note: "Due to ZelCore utilising encryption, your funds will not be accessible in other Full Node software other than ZelCore. Full Node is for advanced users, "
    ...
    zelnode_monitor_mobile: "Add ZelNode to Monitoring",
    add_zelnode_to_monitor_alias: "ZelNode alias to be added to monitoring:",
    add_zelnode_to_monitor_info: "With this functionality you will be able to scan and add the ZelNode to Zelcore Mobile Monitoring system. You will be able to monitor your ZelNodes on your mobile and receive alerts if they go offline. "
    ...
    shield_coinbase_info: "Before rewards can be spent, they must first be shielded. To shield coinbase transactions, enter/select a private (z) adderss to which shielded coins will go.",
    ...
    daemon_excryption_experimental: "Yes, I understand this feature is experimental and I want to use it at my own risk.",
    ...
    zelnode_false_positive_start: "otherwsie you will get a 'false' positive start and will have to start it again.",
    ...
    zelnode_ouputindex: " and ouput Index is ",
    ...
    apps_bio: "Zel Tools is a hub for tools both built by Zel and eventually by developers in the forms of dAPPs utilising ZelDev or tools for ZelCore.",
