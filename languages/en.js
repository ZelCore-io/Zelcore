export default {
  message: {
    ...
    error_invoice: "Error processing obtained invoice",
    ...
    insert_token_ticker: "Insert Token Ticker",
    insert_contract_address: "Insert Contract Address",
    insert_decimals: "Insert number of token decimal places, usually 18",
    ...
    warning_substrate: "Transaction fee may slightly differ, shown value is an estimate. Normal and fast fee policiescan includes a tip to increase transaction priority. It may take a few seconds till transaction is reflected in transaction table.",
    ...
    insufficient_funds_neo: "Insufficient funds to pay transaction fee. Insufficient GAS.",
    ...
    error_loading_wallet_labels: "An error loading your wallet has occured. Please backup your wallet and labels manually and try again",
    ...
    get_zelcore: "Get ZelCore+ for less than a cup of coffee or hold 5000 ZEL in light wallets",
    save_20: "save 20%",
    upgrade: "Upgrade",
    wallets: "Wallets",
    ...
    + "Only continue with the setup after you have your Firo daemon fully syncronized.",
    ...
    + "Payout address is an address to which FiroNode rewards will be distributed. Fee Source Address is an address that needs to have at leats 0.01 XZC for FiroNode registration",
    ...
    znode_lock_list: "Below you can see all the locked transancation outputs available on your Full Node wallet. Click on a row from the table below to unlock the amount so it can be used again in the wallet.",
    ...
    znode: "FiroNode",
    owner_address_unique: "Owner Address has to be uniuque unused address available in your wallet",
    ...
    failiure_timeline: "Failiure Timeline",
    ...
    scan_zelnodes: "Scan ZelNodes",
    scan_znodes: "Scan FiroNodes",
    data_scanned: "Data Scanned!",
    confirm_delete: "Confirm Delete",
    delete_zelnode_mobile: "Do you really want to delete ZelNode {alias}?",
    duplicate_ip: "There is already a ZelNode with the same ip on the list",
    duplicate_alias: "There is already a ZelNode with the same alias on the list",
    add_zelnode: "Add ZelNode",
    enter_zelnode_ipaddress: "Enter your ZelNode's IP",
    all_zelnodes_monitoring_online: "All the ZelNodes you are moniting are confirmed on the network",
  },
};
