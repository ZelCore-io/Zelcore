export default {
  message: {
    ...
    d2fa_requires_minimum: "d2FA requires a small amount of 0.0002 FLUX to be present in your wallet in order to broadcast a d2FA enable transaction. Your d2FA pin will be set after the transaction is confirmed on the blockchain and you have re-logged in.",
    ...
    warning_eth: "Not using enough gas may result in transaction failiure. Unused gas will be returned.",
    ...
    merge_solana_accounts: "You can merge {balance} {unit} to your associated token acocunt. Merging will also close other accounts and return the remaining SOL to your Solana address",
    ...
    no_mergable_balance_found: "No mergable balance found",
    wrapping: "Wrapping",
