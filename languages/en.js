export default {
  message: {
    ...
    memo: "Memo",
    memo2: "Memo:",
    warning_eth_contracts: "Warning: Ethereum contracts takes a few minutes to be shown in explorer! Contracts require Ethereum to be present in your wallet which is a Gas that powers contract execution. If you want to send maximum amount, make sure Maximum button is highlighted.",
    ...
    full_node_launch_note: "Due to ZelCore utilising encryption, your funds will not be accessible in other Full Node software other than ZelCore. If you Full Node is only for advanced users, \n"
    ...
    new_address_generated: "New address generated, don't forget to backup the Private Key.",
    ...
    alias: "Name",
    ipaddress: "IP",
    delete_zelnode_info: "You are about to delete zelnode {zelnodeAlias} alias from configuration file. \n"
    ...
    edit_zelnode_info: "You are about to edit zelnode {zelnodeAlias} alias from configuration file. \n"
                    + "Your Full Node will restart to apply changes.",
    ...
    shield_coinbase_info: "Shielding Coinbase transactions is required in order for them to be spendable. Enter a private (z) address to which shielded funds will go.",
    shield_dont_change_defaults: "Don't change default number of outputs and default fee unless you know what you are doing.",
    ...
    daemon_encryption_password_changed: "Daemon encryption password changed",
    change_daemon_password: "In this dialog you will be able to set a new daemon encryption password.",
    ...
    restart_daemon_info: "Daemon restart is needed when some configuration files have been change for example as of ZelNode setup.",
    ...
    start_zelnode_all_or_specific: "In this page you are be able to start all ZelNodes or a specific one.",
    zelnode_15_confirmations: "At least 15 confirmations (around 30 minutes) are required before you can start your ZelNode, ",
    zelnode_false_positive_start: "before that you will get a 'false' positive start.",
    ...
    confirm_zelnode_status: "Please confirm your ZelNode status on ZelNode server or on ZelCash explorer.",
    zelnode_missing_status: "Your ZelNode might show as Missing on ZelCore because it takes some time for a to ZelNodes propagate the status to the network.",
    ...
    special_chars_not_allowed_zelnname: "Special characters are not allowed on Zelnode name",
    special_chars_not_allowed_labels: "Special characters are not allowed on wallet labels",
    ...
    daemon_not_starting: "Full Node wallet is not starting. Usually when Full Node doesn`t start it can be related to firewall or wrong wallet, masternode, zelnode configuration file. Please check those before trying the reindex option.",
    daemon_issue: "Error: Full Node Not Starting",
    error_saving_config_file: "Error saving configuration file. If wallet doesn`t connect please close Full Node.",
    error_saving_zelnode_config_file: "Error saving zelnode.conf file. If wallet doesn`t connect please close Full Node.",
    ...
    + "ATTENTION! If you have used Full Node on zelcore with encryption enable and disable encryption if you launch Full Node again on ZelCore a new wallet.dat will be created and used.",
    ...
    crux_register_info: "Registers your CruxID and ties it with your ZelCore {wallet} account. After registration is completed, you can manage your CruxID account directly from ZelCore. Be noted that all address in {wallet} will be publicly exposed. Registering CruxID may take several hours.",
    ...
    crux_remap_to: "Remap CruxID to",
    crux_warning_id_not_exists: "Your CruxID is still being propagated. Management will be available within few hours.",
