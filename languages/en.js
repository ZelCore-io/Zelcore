...
export default {
  message: {
    ...
    import_goerli_token: "Import Goerli Token",
    import_sepolia_token: "Import sepolia Token",
    import_base_token: "Import Base Token",
    import_goerli_base_token: "Import Goerli Base Token",
    ...
    no_provider_options: "We haven't found any providers that can process this swap",
    ...
    error_min_available: "We haven't found any swaps that can send {token} below {minimum}. Please add to your {token} balance.",
