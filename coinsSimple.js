...
const coins = {
  ...
  testnetropstenethereum: {
    ...
    decimals: 18,
    chainID: 5,
    explorer: backends.goerli.explorer,
    node: backends.goerli.node,
    api: backends.goerli.api,
  },
  ...
  basegoerli: {
    ...
    color: "#0052FF",
    decimals: 18,
    explorer: backends.basegoerli.explorer,
    node: backends.basegoerli.node,
    api: backends.basegoerli.api,
  },
  usdcbase: {
    coin: "usdcbase",
    name: "USD Coin BASE",
